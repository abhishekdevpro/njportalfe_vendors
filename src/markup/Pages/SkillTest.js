                                  ...
                                  >
                                    ...
                                    >
                                      ...
                                      >
                                        ...
                                        <span style={{ fontWeight: "400" }}>
                                          {
                                            Math.floor(card.skill_assessment.results
                                              .Percentage )|| '0'
                                          }
                                        </span>
                                      </h3>
...
Following instructions are common for all job seekers. <br/></h5>
...
8. Tests will be automatically submitted after the given time limit. <br/>
          ...
          {selectedCard && (
            ...
            >
              ...
              >
                <h5 className="mb-2">Are you sure you want to close?{selectedCard.title}</h5>
