...
function Aboutus1() {
    ...
    <div className="mx-3 mx-lg-5">
        <img src={logo1} alt="SBE Logo" style={{ height: 'auto', maxWidth: '250px' }} />
                                ...
                                <div className="candidate-title mx-3 mx-sm-5 px-3 px-sm-5">
    <h1 className="text-center" style={{ fontSize: "clamp(24px, 5vw, 30px)", fontWeight: 'bold' }}>Our Services Scope</h1>
    <p className="text-center mb-3 mb-sm-0">Hyper V Solutions offers a wide range of services, from AI-enabled job portals and Edtech portals to amazing AI-enabled home services. The video below explains our services in 7 minutes.</p>
</div>
...
></iframe>
    ...
    <div className="row justify-content-around mt-5">
        <div className="col-12 col-lg-5 d-flex justify-content-center">
            <div className="mx-3 mx-lg-5">
                <img src={logo2} alt="SBE Logo" style={{ height: 'auto', maxWidth: '100%' }} />
            </div>
        </div>
        <div className="col-12 col-lg-5">
            <div style={{ maxWidth: '370px' }} className="mx-3 mx-lg-5">
                <h1 className="mb-4" style={{ fontSize: 'clamp(14px, 5vw, 30px)', fontWeight: 'bold' }}>Conclusion</h1>
                <p className="mb-0">
                    As a registered Small Business Enterprise (SBE) and Disadvantaged Business Enterprise (DBE), diversity and inclusion are at the core of our values. We're committed to providing equal opportunities and support to all individuals.
                </p>
                <p className="mb-0 mt-3">
                    But our impact doesn't stop there. As part of the Hyper V Solutions incubator, we're joined by visionaries like Ultra Aura, an EdTech portal committed to shaping the future of education. Together, we're not just redefining recruitment – we're reshaping industries and driving positive change in our communities and beyond.
                </p>
            </div>
        </div>
    </div>
